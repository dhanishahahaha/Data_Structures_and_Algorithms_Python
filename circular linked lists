...
CLL helps to propagate or move in both directions, every CLL node has a item, next. 
CLL has a self.last instead of self.start, which is connected to the last node of the list.
The next of the last node of the list is connected to the first node of the list.
This helps to reduce the time by avoiding traversing the list everytime which accessing, insertion or deletion
of nodes.
